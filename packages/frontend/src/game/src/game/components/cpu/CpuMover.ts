    ...
    if (directions.length > 0) {
      ...
      switch (this.mode.value) {
        case 'random':
          ...
          targetX =
            newDirection === 'left' ? cpuX - 10 : newDirection === 'right' ? cpuX + 10 : cpuX;
        ...
        case 'hunt-burger':
          ...
          newDirection =
            directionsSorted[
              Math.round(this.random(0, this.directionAccuracy)) % directionsSorted.length
            ]!.dir;
